  ...
  _addAddress() async {
    if (_formKey.currentState.validate()) {
      ...
      print('${_houseController.text}, ${_pinCodeController.text}, ${_stateController.text}, '
          ...
          '${_mobileController.text}, ${widget.userId} ' );
      if (_cityId == 0) {
      ...
      var response = await http.post(Connection.addressAdd, body: {
      ...
      if (decodedData['status'] == true) {
        _showAlertAndPop('Address Added', 'Address added successfully.');
      } else {
        _showAlert('Failed', 'Something went wrong while adding address.');
      }
    } else {
      setState(() {
        _autoValidate = true;
